        ...
        <div class="col-sm-6 hidden-xs">
            <div class="header-section">
                <ul class="breadcrumb breadcrumb-top">
                    <li><?php echo CHtml::link('Manage Customer', array('list_customer')) ?></li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="block">
            ...
            echo CHtml::link('Add', array('create_customer'), array('class' => 'btn btn-effect-ripple btn-info')); ?>
          ...
          array(
            ...
            'value'=>function($data)
            {
              echo CHtml::link($data->name, array('cashevent/list_customer_bill',"id"=>$data->id), array('class'=>'link_blue'));
                // echo $data->name;
            }
          ),
					// 'mobile',
                        ...
                        'buttons' => array(
                            'ledger' => array(
                             ...
                             'bill' => array(
                                ...
                                'type' => 'raw',
                                 'url'=>'Yii::app()->createUrl("cashevent/list_customer_bill",array("id"=>$data->id))'
                            ),
                            ...
                            'update' => array(
                                ...
                                'type' => 'raw',
                                'url'=>'Yii::app()->createUrl("Customer/update_customer",array("id"=>$data->id))'
                            ),
                           /* 'view' => array(
                                'label' => '<i class="fa fa-eye"></i>',
                                'imageUrl' => false,
                                ...
                                'type' => 'raw',
                                'url'=>'Yii::app()->createUrl("Customer/view_customer",array("id"=>$data->id))'
                            ),*/
                             'view' => array(
                                'label' => '<i class="fa fa-eye"></i>',
                                'imageUrl' => false,
