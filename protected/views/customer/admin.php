...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="block">
            ...
            echo CHtml::link('Add', array('create_supplier'), array('class' => 'btn btn-effect-ripple btn-info')); ?>
			...
			<?php $this->widget('zii.widgets.grid.CGridView', array(
				...
				'columns'=>array(
					...
					// 'id',
            // 'url'=>'Yii::app()->createUrl("cashevent/list_supplier_event",array("id"=>$data->id))'
          array(
            'name'=>'name',
                    ...
                    /*array(
                        ...
                        'buttons' => array(
                            ...
                            'update' => array(
                                ...
                                'type' => 'raw',
                                 'url'=>'Yii::app()->createUrl("customer/update_supplier",array("id"=>$data->id))'
                            ),
                            ...
                            'bill' => array(
                                ...
                                'type' => 'raw',
                                 'url'=>'Yii::app()->createUrl("cashevent/list_supplier_bill",array("id"=>$data->id))'
                            ),
                            ...
                            /*'view' => array(
                                ...
                                'type' => 'raw',
                                 'url'=>'Yii::app()->createUrl("customer/view_supllier",array("id"=>$data->id))'
                            ),*/
                            'view' => array(
                                'label' => '<i class="fa fa-eye"></i>',
                                'imageUrl' => false,
