                ...
                'columns' => array(
                    ...
                    array(
                        ...
                        'buttons' => array(
                            ...
                            'pdf' => array('label' => '<i class="fa fa-file-pdf-o"></i>', 'imageUrl' => false, 'url' => 'Yii::app()->createUrl("supplierLedger/pdf", array("id"=>$data->id))', 'options' => array('class' => 'btn btn-sm btn-primary', 'title' => 'Download PDF')),
                            'update' => array('label' => '<i class="fa fa-pencil"></i>', 'imageUrl' => false, 'url' => 'Yii::app()->createUrl("supplierLedger/update", array("id"=>$data->id))', 'options' => array('class' => 'btn btn-sm btn-success')),
