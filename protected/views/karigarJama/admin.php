                ...
                'columns' => array(
                    ...
                    array(
                        ...
                        'buttons' => array(
                            ...
                            'print' => array('label' => '<i class="fa fa-print"></i>', 'imageUrl' => false, 'url' => 'Yii::app()->createUrl("karigarJama/print", array("id"=>$data->id))', 'options' => array('class' => 'btn btn-sm btn-default', 'title' => 'Print', 'target' => '_blank')),
                            'update' => array(
...
$(function() {
    $('#karigar-delete-selected-locked').on('click', function() {
        var ids = $.fn.yiiGridView.getChecked('karigar-jama-grid', 'selectedIds');
        if (!ids || ids.length === 0) {
