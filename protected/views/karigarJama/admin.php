...
<div class="row">
    <div class="col-lg-12">
        <div class="block">
            <div class="block-title"><h2>Jama Vouchers</h2></div>
            <?php echo CHtml::link('Add Jama Voucher', array('create'), array('class' => 'btn btn-effect-ripple btn-info')); ?>
            <?php
                ...
                'columns' => array(
                    ...
                    array(
                        ...
                        'buttons' => array(
                            ...
                            'update' => array('label' => '<i class="fa fa-pencil"></i>', 'imageUrl' => false, 'url' => 'Yii::app()->createUrl("karigarJama/update", array("id"=>$data->id))', 'options' => array('class' => 'btn btn-sm btn-success')),
