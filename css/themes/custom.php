...
$bgcolor = base64_decode($_REQUEST['bgcolor']);
$bgcolor1 = base64_decode($_REQUEST['bgcolor1']);
$bgcolor2 = base64_decode($_REQUEST['bgcolor2']);
...
.sidebar-nav ul a {
    border-left-color: #353a4d;
}

#sidebar-alt,
#sidebar-alt-close {
    background: rgba(53, 58, 77, .9);
}
...
.block {
    -webkit-box-shadow: 0 2px 0 rgba(223, 218, 232, .5);
    box-shadow: 0 2px 0 rgba(223, 218, 232, .5);
}

.block-title {
    background: rgba(223, 218, 232, .15);
}

@media screen and (min-width: 768px) {

    #page-content.inner-sidebar-left #page-content-sidebar {
        border-right-color: #dfdae8;
    }
...
.nav a:hover .caret,
.nav a:focus .caret {
    border-top-color: <?php echo $bgcolor; ?>;
    border-bottom-color: <?php echo $bgcolor; ?>;
}

.btn-primary,
.fc-state-default {
    background-color: <?php echo $bgcolor2; ?>;
    border-color: <?php echo $bgcolor2; ?>;
}
...
.fc-state-disabled {
    ...
    border-color: <?php echo $bgcolor1; ?>;
}
